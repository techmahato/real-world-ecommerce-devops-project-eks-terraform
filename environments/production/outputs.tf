...
output "bastion_public_ip" {
  description = "Bastion public IP. Null when bastion is disabled."
...
output "eks_oidc_provider_arn" {
  description = "OIDC provider ARN. Pass to IRSA-using modules."
...
output "eks_kubeconfig_command" {
  description = "Run from the bastion: aws eks update-kubeconfig command."
...
output "cluster_summary" {
  ...
  value = {
    ...
    eks = {
      ...
      access_pattern     = "PRIVATE endpoint only - SSM into bastion FIRST, then kubectl"
    }
